...
class KontantstøtteServiceTest : AbstractServiceTest() {
    ...
    fun `skal returnere kontantstøtte for alle perioder i input`() {
        ...
        assertAll(
            ...
            Executable { assertThat(beregnetKontantstøtte[0].visningsnavn).isEqualTo(Inntektsrapportering.KONTANTSTØTTE.visningsnavn.intern) },
            ...
            Executable { assertThat(beregnetKontantstøtte[1].visningsnavn).isEqualTo(Inntektsrapportering.KONTANTSTØTTE.visningsnavn.intern) },
            ...
            Executable { assertThat(beregnetKontantstøtte[2].visningsnavn).isEqualTo(Inntektsrapportering.KONTANTSTØTTE.visningsnavn.intern) },
            ...
            Executable { assertThat(beregnetKontantstøtte[3].visningsnavn).isEqualTo(Inntektsrapportering.KONTANTSTØTTE.visningsnavn.intern) },
            ...
            Executable { assertThat(beregnetKontantstøtte[4].visningsnavn).isEqualTo(Inntektsrapportering.KONTANTSTØTTE.visningsnavn.intern) },
