...
class OvergangsstønadServiceTest {
    ...
    fun `skal returnere Overgangsstønad når dagens dato er 2023-01-01`() {
        ...
        assertAll(
            ...
            Executable { assertThat(beregnedeOvergangsstønader[0].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(100) },
            ...
            Executable { assertThat(beregnedeOvergangsstønader[1].periodeFra).isEqualTo(YearMonth.parse("2021-12")) },
            ...
            Executable { assertThat(beregnedeOvergangsstønader[1].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(7800) },
            ...
            Executable { assertThat(beregnedeOvergangsstønader[2].periodeFra).isEqualTo(YearMonth.parse("2022-09")) },
            Executable { assertThat(beregnedeOvergangsstønader[2].periodeTil).isEqualTo(YearMonth.parse("2022-11")) },
            Executable { assertThat(beregnedeOvergangsstønader[2].inntektPostListe.size).isEqualTo(3) },
            Executable { assertThat(beregnedeOvergangsstønader[2].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(3300) }
        )
    }
    ...
    fun `skal returnere Overgangsstønad når dagens dato er 2023-01-10`() {
        ...
        assertAll(
            ...
            Executable { assertThat(beregnedeOvergangsstønader[1].inntektPostListe.size).isEqualTo(12) },
            Executable { assertThat(beregnedeOvergangsstønader[1].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(9000) },
            ...
            Executable { assertThat(beregnedeOvergangsstønader[2].periodeFra).isEqualTo(YearMonth.parse("2022-01")) },
            Executable { assertThat(beregnedeOvergangsstønader[2].periodeTil).isEqualTo(YearMonth.parse("2022-12")) },
            Executable { assertThat(beregnedeOvergangsstønader[2].inntektPostListe.size).isEqualTo(12) },
            Executable { assertThat(beregnedeOvergangsstønader[2].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(9000) },
            ...
            Executable { assertThat(beregnedeOvergangsstønader[3].periodeFra).isEqualTo(YearMonth.parse("2022-10")) },
            Executable { assertThat(beregnedeOvergangsstønader[3].periodeTil).isEqualTo(YearMonth.parse("2022-12")) },
            Executable { assertThat(beregnedeOvergangsstønader[3].inntektPostListe.size).isEqualTo(3) },
            Executable { assertThat(beregnedeOvergangsstønader[3].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(3600) }
        )
    }
    ...
    fun `skal returnere Overgangsstønad når dagens dato er 2023-09-01`() {
        ...
        assertAll(
            ...
            Executable { assertThat(beregnedeOvergangsstønader[2].inntektPostListe.sumOf { it.beløp.toInt() }).isEqualTo(11700) },
